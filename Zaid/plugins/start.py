...
async def start(event):
    ...
    if event.is_private:
       await event.client.send_file(event.chat_id,
        ...
        [Button.url("📲 𝐑𝐞𝐠𝐢𝐬𝐭𝐞𝐫", f"http://www.9987up.cc/#/register?r_code=aP5SD39416")],
        [Button.url("📁 𝐂𝐡𝐚𝐧𝐧𝐞𝐥", f"https://t.me/tcwithcharvi1"), Button.url("🌐 𝐖𝐞𝐛𝐬𝐢𝐭𝐞", f"https://newcolorprediction.blogspot.com/2023/04/tc-lottery-app-download-tc-lottery-apk.html")],
